...
const Hero = () => {
  const social_media = [
   {social_logo: "logo-github", social_link: "https://github.com/Abdul-Bsit"} ,
   {social_logo: "logo-linkedin", social_link: "https://www.linkedin.com/in/abdul-basit-b49662222/"} ,
  ];
        ...
        <div className="md:text-left text-center">
         ...
         text-white font-bold"
          >
            ...
            My name is <span>Abdul  Basit</span>
          </h1>
